...
import { DonationRegistrationStatus, DonationType } from '~/constants/enum'
...
export default class DonationRegistration {
  ...
  constructor(donationRegistration: DonationRegistrationType) {
    ...
    this.donation_process_id = donationRegistration.donation_process_id
    this.health_check_id = donationRegistration.health_check_id
    ...
    this.blood_component_ids = donationRegistration.blood_component_ids || []
